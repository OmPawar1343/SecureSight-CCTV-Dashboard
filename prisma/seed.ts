...
async function main() {
  ...
  const incidentsData = [
    ...
    // Entrance
    { cameraId: cameraList[2].id, type: 'Unauthorised Access', tsStart: new Date('2025-07-23T07:00:00Z'), tsEnd: new Date('2025-07-23T07:05:00Z'), thumbnailUrl: '/images/thumbnail3.png', resolved: false },
    { cameraId: cameraList[2].id, type: 'Gun Threat', tsStart: new Date('2025-07-23T08:00:00Z'), tsEnd: new Date('2025-07-23T08:10:00Z'), thumbnailUrl: '/images/thumbnail3.png', resolved: false },
    { cameraId: cameraList[2].id, type: 'Face Recognised', tsStart: new Date('2025-07-23T09:00:00Z'), tsEnd: new Date('2025-07-23T09:02:00Z'), thumbnailUrl: '/images/thumbnail3.png', resolved: true },
    // More incidents
    ...
    { cameraId: cameraList[2].id, type: 'Unauthorised Access', tsStart: new Date('2025-07-23T12:00:00Z'), tsEnd: new Date('2025-07-23T12:05:00Z'), thumbnailUrl: '/images/thumbnail3.png', resolved: true },
  ];
